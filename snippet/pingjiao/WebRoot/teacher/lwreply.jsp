	...
	<body>
		...
		<form name="leavewordform" method="post" action="<%=SystemParam.getSiteRoot()%>/admin/leavewordmanager.do" id="leavewordForm">
			<table class="grid" cellspacing="1" width="100%">
				...
				<input type="hidden" name="forwardurl" value="/admin/leavewordmanager.do?actiontype=get&forwardurl=/teacher/leavewordmanager.jsp" />
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<textarea name="replycontent" id="txtReplycontent" style="width:98%;height:200px;">${requestScope.leaveword.replycontent}</textarea>
					</td>
				</tr>			
				<tr>
					<td colspan="4">
