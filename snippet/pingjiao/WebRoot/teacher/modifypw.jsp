...
<html>
  	...
  	<body >
		...
		<form name="form1" class="form-horizontal" action="<%=SystemParam.getSiteRoot()%>/admin/teachermanager.do"  id="form1" method="post"  >
			...
			<input type="hidden"  name="errorpageurl"  value="/teacher/modifypw.jsp?seedid=101"/>
