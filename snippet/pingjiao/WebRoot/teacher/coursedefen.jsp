					...
					<tbody>
						<tr>
							<td>课程名 
								...
								<input type="hidden" name="forwardurl" value="/teacher/coursedefen.jsp"/>
   		...
   		<table id="module" width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-record-table">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=temcourse.getTname()%></td>
					<td>
						<span class="weight14font"><%=temcourse.getPjcount()%>人</span>
					</td>
					<td>
						<span class="weight14font"><%=temcourse.getAvgscore()%>分</span>
					</td>
					<td>
						<a class="btn btn-success" href="<%=SystemParam.getSiteRoot() %>/teacher/kcvoteres.jsp?subno=<%=temcourse.getSubno()%>">
