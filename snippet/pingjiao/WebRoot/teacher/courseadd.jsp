	...
	<body>
		...
		<form name="courseform" class="form-horizontal" method="post" action="<%=SystemParam.getSiteRoot()%>/admin/coursemanager.do" id="courseForm">
			<table class="grid" cellspacing="1" width="100%">
				...
				<input type="hidden" name="tname" value="${teacher.name}" />
				<input type="hidden" name="tno" value="${teacher.tno}" />
				<input type="hidden" name="errorurl" value="/admin/courseadd.jsp" />
				<input type="hidden" name="forwardurl" value="/admin/coursemanager.do?actiontype=get&tno=${teacher.tno}&forwardurl=/teacher/coursemanager.jsp" />
				<tr>
				...
				<tr>
					...
					<td>
						<input name="subno" validate="{required:true,messages:{required:'请输入课程编号'}}" 
							value="${requestScope.course.subno}" class="input-txt" type="text" id="txtSubno" />
					</td>
				</tr>
				<tr>
