...
<div class="head">
	<div class="top">
   		<div style="position:absolute;font-size:25px;font-weight:666;color:white;left:15px;top:50%;transform:translateY(-50%);">网上评教系统(学生)</div>
    	...
    	<div class="top_user" style="position:absolute;top:50%;transform:translateY(-50%);right:70px;">Hi,${student.name}!</div>
	</div>
</div>
