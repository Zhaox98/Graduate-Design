			...
			<form id="searchForm" action="<%=SystemParam.getSiteRoot() %>/admin/pingjiaomanager.do" method="post">
				<table cellspacing="0" width="100%">
					<tbody>
						<tr>
							<td> 
								<input name="stno" value="${student.stno}" class="input-txt" type="hidden" id="stno" /> 
								<input type="hidden" name="actiontype" value="search" /> 
								<input type="hidden" name="seedid" value="${seedid}" /> 
								<input type="hidden" name="forwardurl" value="/student/pingjiaomanager.jsp" />
							</td>
						</tr>
					</tbody>
				</table>
		...
		<table id="pingjiao" width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-record-table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class="orange-href" href="<%=SystemParam.getSiteRoot()%>/student/pingjiaodetails.jsp?id=<%=tempingjiao.getId()%>">查看</a>
					</td>
				</tr>
				<% } } %>
			</tbody>
