		...
		<form name="adminform" method="post" action="<%=SystemParam.getSiteRoot()%>/admin/adminmanager.do" id="adminForm">
			<table class="grid" cellspacing="1" width="100%">
				...
				<tr>
					...
					<td width="35%">
						<input name="username"  validate="{required:true,messages:{required:'请输入用户名'}}" value="${requestScope.admin.username}"
							class="input-txt" type="text" id="txtUsername" />
					</td>
					<td width="50%" colspan="2" rowspan="6">
						<img id="imgXiangpian" width="200px" height="200px" src="${requestScope.admin.xiangpian}" />
						<div>
				...
				<tr>
					...
					<td>
						<input name="password" validate="{required:true,messages:{required:'请输入密码'}}" value="${requestScope.admin.password}"
				...
				<tr>
					...
					<td>
						<input name="creator" validate="{required:true,messages:{required:'请输入创建人'}}"  value="${requestScope.admin.creator}"
				...
				<tr>
					...
					<td>
						<input name="realname" value="${requestScope.admin.realname}" class="input-txt" type="text" id="txtRealname" />
					</td>
				</tr>
				<tr>
					<td align="right">昵称:</td>
					<td>
						<input name="nickname" value="${requestScope.admin.nickname}" class="input-txt" type="text" id="txtNickname" />
					</td>
