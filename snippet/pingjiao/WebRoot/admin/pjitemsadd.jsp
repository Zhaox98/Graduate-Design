...
<html>
	...
	<body>
		...
		<form name="pjitemsform"  method="post" action="<%=SystemParam.getSiteRoot()%>/admin/pjitemsmanager.do"  id="pjitemsForm">
			<table class="grid" cellspacing="1" width="100%">
				<input type="hidden" name="id" value="${id}" />
				<input type="hidden" name="actiontype" value="${actiontype}" />
				<input type="hidden" name="seedid" value="${seedid}" />
				<input type="hidden" name="errorurl" value="/admin/pjitemsadd.jsp" />
				<input type="hidden" name="forwardurl" value="/admin/pjitemsmanager.do?actiontype=get&forwardurl=/admin/pjitemsmanager.jsp" />
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<textarea   name="title" rows="4"  id="txtTitle" style="width:60%;height:100px;" 
							validate="{required:true}" >${requestScope.pjitems.title}</textarea>
					</td>
				</tr>
				<tr>
				 	<td> </td>
