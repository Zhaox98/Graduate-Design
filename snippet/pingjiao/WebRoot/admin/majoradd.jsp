...
<html>
	...
	<body>
		...
		<form name="majorform"  method="post" action="<%=SystemParam.getSiteRoot()%>/admin/majormanager.do"  id="majorForm">
			<table class="grid" cellspacing="1" width="100%">
				<input type="hidden" name="id" value="${id}" />
				<input type="hidden" name="actiontype" value="${actiontype}" />
				<input type="hidden" name="seedid" value="${seedid}" />
				<input type="hidden" name="errorurl" value="/admin/majoradd.jsp" />
				<input type="hidden" name="forwardurl" value="/admin/majormanager.do?actiontype=get&forwardurl=/admin/majormanager.jsp" />
				<tr>
				...
				<tr>
					...
					<td>
						<input name="name" placeholder="专业名" validate="{required:true,messages:{required:'请输入专业名'}}" 
							value="${requestScope.major.name}" class="input-txt" type="text" id="txtName"  />
					</td>
				</tr>
				<tr>
					<td colspan="4">
