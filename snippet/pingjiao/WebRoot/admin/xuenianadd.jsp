...
<html>
	...
	<body>
		...
		<form name="xuenianform"  method="post" action="<%=SystemParam.getSiteRoot()%>/admin/xuenianmanager.do"  id="xuenianForm">
			<table class="grid" cellspacing="1" width="100%">
				<input type="hidden" name="id" value="${id}" />
				<input type="hidden" name="actiontype" value="${actiontype}" />
				<input type="hidden" name="seedid" value="${seedid}" />
				<input type="hidden" name="errorurl" value="/admin/xuenianadd.jsp" />
				<input type="hidden" name="forwardurl" value="/admin/xuenianmanager.do?actiontype=get&forwardurl=/admin/xuenianmanager.jsp" />
				<tr>
				...
				<tr>
					...
					<td>
						<input name="niandu" placeholder="学年" validate="{required:true,messages:{required:'请输入学年'}}" value="${requestScope.xuenian.niandu}" class="input-txt" type="text" id="txtNiandu"  />
					</td>
				</tr>
				<tr>
					<td colspan="4">
